...
public class DefaultConsumer extends AbstractConsumer {
	...
	@Override
	protected void perform(String facadeId, Object... models) throws Exception {
		IFacade facade = (IFacade) AppServerBeanFactory.getBeanFactory().getBean(facadeId);
	...
	private Request deserializeRequest(byte[] aryByte) throws Exception{
	...
	private Object deserializeContent(Request request) throws Exception{
